...
<form method="POST" enctype="multipart/form-data" name="product_form" id="product_form" >
  ...
  <div class="form-group">
    ...
    <input type="product_description" class="form-control" id="product_description"  name="product_description" placeholder="Enter Product Detail">
  </div>
...
var files   = document.querySelector('input[type=file]').files;
 ...
 for (let i = 0; i < files.length; i++) {
	if(files[i])
	{
        ...
        "<input type='hidden' name='images_base64[]' class='base64_images' value="+e.target.result+" />"
    );

			
			
		}
		console.log("file " +files.length + "base 64 "+base64.length);
    };
